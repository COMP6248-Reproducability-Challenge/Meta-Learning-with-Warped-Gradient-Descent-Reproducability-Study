...
from utilsOmni import build_kwargs, log_status, write_train_res, write_val_res, unlink, consolidate
...
def main():
    ...
    model = get_model(args, criterion, torch.device("cuda:0"))
    model2 = get_model(args, criterion, torch.device("cuda:0"))
